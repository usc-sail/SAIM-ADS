...
test_data_keys=[os.path.splitext(x.split("/")[-1])[0] for x in list(test_data['clip_feature_path'])]
train_data_keys=[os.path.splitext(x.split("/")[-1])[0] for x in list(train_data['clip_feature_path'])]
val_data_keys=[os.path.splitext(x.split("/")[-1])[0] for x in list(val_data['clip_feature_path'])]

#find intersection of keys
print(len(list(set(test_data_keys) & (set(train_data_keys)))))
print(len(list(set(test_data_keys) & (set(val_data_keys)))))
print(len(list(set(val_data_keys) & (set(train_data_keys)))))
