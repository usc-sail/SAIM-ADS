...
parser.add_argument('--transcript_file', type=str, default='/media/data/public-data/ads_complete_repo/ads_transcripts/combined_transcripts/en_combined_transcripts.json', help='path to the transcript file')
parser.add_argument('--model_name', type=str, default='flan-xl', help='name of the model')
parser.add_argument('--split_file', type=str, default='/media/data/public-data/ads_complete_repo/ads_codes/SAIM-ADS/data/SAIM_data/SAIM_multi_task_tone_soc_message_topic_data_no_zero_files.csv', help='path to the split file')
...
with open(f"predicted_labels_{model}_{task_name}.json",'r') as f:
